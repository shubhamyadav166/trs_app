...
const Value = () => {
    return (
        <section>
            <div className='flex flex-col justify-around md:flex-row mt-15 pb-5 '>
                {/* left section */}
                <div className='w-full items-center bg-slate-50 rounded-2xl' >
                ...
                <div className='w-full px-15 sm:pr-25  items-cente  '>
                    <div className='flex flex-col items-center gap-3'>
                        ...
                        <span className='text-slate-600 text-2xl md:text-3xl font-ptserif'>Value we give to you</span>
                        <span className='text-slate-400 text-center pb-2'>We provide the best service <br />
                            Because the right place to live can change your life.
                        </span>
                        <Accordion
                            className='accordian'
